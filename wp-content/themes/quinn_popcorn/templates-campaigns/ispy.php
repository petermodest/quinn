...
<script type="text/javascript" src="<?php bloginfo( 'stylesheet_directory' ); ?>/assets/js/jquery.masonry.min.js"></script>
		...
		<script type="text/javascript">
			...
			$(document).ready(function (){
				...
				var $container = $('#quinn-ispy');
					$container.imagesLoaded(function(){
					  $container.masonry({
					    itemSelector : '.ispy-item',
			          columnWidth: 300,
						 gutterWidth: 30
...
<!-- ABOVE = QUINN -->
	...
	<ul id="quinn-ispy">
		...
		<li id="ispy-intro" class="ispy-item">

			<div id="ispy-logo"></div>
			<h3>The Game</h3>
			<p>You post a pic of Quinn Popcorn on the shelf, and we send you coupon for a free box. No joke. This may be the best deal ever.</p>
			<p>A year and half ago we landed a spot in our first store. Today it's still totally surreal to see Quinn on the shelf. Can't wait to see your photos of Quinn in the wild!</p>


			<h3>How You Do It</h3>
				<ol>
					<li>Snap a pic of Quinn Popcorn on the shelf</li>
					<li>Post a photo + store name + @quinnpopcorn + #ispyquinnpopcorn
(Instagram, Twitter, or our Facebook wall)</li>
					<li>Email us at <a href="mailto:ispy@quinnpopcorn.com">ispy@quinnpopcorn.com</a> to get your coupon for a free box!</li>
				</ol>
			<h3>A Few Details</h3>
			<p>> Only one coupon per store, so be the first to your local spot!</p>
			<p>> If your photo makes us crack up we will throw in a little something extra!</p>
			</li>
