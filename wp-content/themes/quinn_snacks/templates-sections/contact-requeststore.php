								...
								<? else : ?>
									...
									<form action="<? the_permalink(); ?>" id="contactForm" method="post">
										<ul class="contactform">			
											<li>
												<input type="text" placeholder="Store Name" name="contactStorename" id="contactStorename" value="<? if(isset($_POST['contactStorename'])) echo $_POST['contactStorename'];?>" class="required requiredField form-text" />
												<? if( $nameError != '' ) : ?>
													<span class="error"><?= $nameError ?></span>
												<? endif ?>
											</li>
											<li>
												<input type="text" placeholder="Store City" name="contactStorecity" id="contactStorecity" value="<? if(isset($_POST['contactStorecity'])) echo $_POST['contactStorecity'];?>" class="required requiredField form-text" />
												<? if( $nameError != '' ) : ?>
													<span class="error"><?= $nameError ?></span>
												<? endif ?>
											</li>
											<li>
												<input type="text" placeholder="Store State" name="contactStorestate" id="contactStorestate" value="<? if(isset($_POST['contactStorestate'])) echo $_POST['contactStorestate'];?>" class="required requiredField form-text" />
												<? if( $nameError != '' ) : ?>
													<span class="error"><?= $nameError ?></span>
												<? endif ?>
											</li>			
